<%-- 
    Document   : mhsedit
    Created on : Jan 10, 2023, 9:21:07 AM
    Author     : BCMedia
--%>
...
<jsp:include page="head.jsp?jdpg=Edit Data Mahasiswa&ucss=mhsview"></jsp:include> 
<%
...
<form action="mhsupdate.jsp" method="post">  
...
<label class="form-label">Nama</label>
    <input type="text" value="<%=m.getNAMA()%>" name="NAMA" class="form-control">
...
<label class="form-label">TGL Lahir</label>
    <input type="date" value="<%=m.getTGLAHIR()%>" name="TGLAHIR" class="form-control">
